...
// Soft delete file route - REMOVED REGEX PATTERN
...
// Update file route - REMOVED REGEX PATTERN
...
// Share file route - REMOVED REGEX PATTERN
router.post('/:fileId/share', authenticateJWT, async (req: Request, res: Response) => {
  ...
  try {
    ...
    const shareableLink = `${process.env.BASE_URL || 'http://localhost:3000'}/files/share/${shareToken}`;
...
// Access shared file route - REMOVED REGEX PATTERN
...
// Edit shared file route - REMOVED REGEX PATTERN
...
// Subscribe to file updates - REMOVED REGEX PATTERN
